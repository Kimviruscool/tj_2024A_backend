...
//        1.하나의 정수형으로  입력받아 7의 배수 이면 'O' 아니면 'X' 출력 하시오.
        System.out.print(" >> 정수 입력 : ");
        int int1 = scanner.nextInt();
        System.out.println(int1 % 7 == 0 ? " O " : " X ");

        //2. 내꺼 하나의 정수형으로  입력받아 홀수 이면 'O' 아니면 'X' 출력 하시오.
        System.out.print("정수 : ");
        int 정수 = scanner.nextInt();
        System.out.println(정수 % 2 == 1 ? "홀수" : "짝수");

        //3.  하나의 정수형으로  입력받아 7의 배수 이면서 짝수 이면 'O' 아니면 'X' 출력 하시오
        System.out.print("정수를 입력하세요 : ");
        int num3 = scanner.nextInt();
        System.out.println((num3 % 7 == 0 && num3 % 2 == 0) ? "O" : "X");

        //4. 하나의 정수형으로  입력받아 11의 배수 이거나 짝수 이면 'O' 아니면 'X' 출력 하시오
        System.out.print("수 입력 : ");
        int num = scanner.nextInt();
        System.out.println((num % 11 ==0 || num % 2==0) ? "o" : "x");

        //5.두개의 정수형으로 입력받아 더 큰수 출력 하시오.
        ...
        //6. 정수형으로 반지름을 입력받아 원 넓이 출력 하시오. 소수점 둘째 자리 까지 출력하시오.
        ...
        //7. 실수형으로 두번 입력받아 앞 실수의 값이 뒤의 값의 몇% 인지 소수점 첫째 자리까지 출력하시오.
        ...
        //8.사다리꼴 넓이 구하기[윗변과 밑변 높이를 입력받아 출력하기 , 소수점 첫째 자리까지 출력하시오.
        ...
        int 사다리꼴넓이 = (윗변 + 밑변) * 높이 / 2;
        System.out.printf("넓이: %.1f\n",사다리꼴넓이);

        //9.키를 정수를 입력받아 표준체중 출력하기 , 정수형으로 출력하시오.
        ...
        //10. 내꺼 키와 몸무게를 입력받아 BMI 출력하기 , 소수점 둘째 자리 까지 출력하시오.
        //        계산식) BMI 계산식 = > 몸무게 / ((키 / 100) * (키 / 100))
        ...
        //11. inch 를 입력받아 cm 로 변환하기  , 소수점 둘째 자리까지 출력하시오.
        //        계산식) 1 inch -> 2.54cm
        ...
        //12. 중간고사, 기말고사, 수행평가를 입력받아 반영비율별 계산하여 소수 둘째자리까지 점수 출력하시오
        //        계산식 반영비율)  중간고사 반영비율 => 30 %  / 기말고사 반영비율 => 30 %   / 수행평가 반영비율 => 40 %
        System.out.print("중간고사 :"); int 중간고사= scanner.nextInt(); //30%반영
        System.out.print("기말고사 :"); int 기말고사= scanner.nextInt(); //30%반영
        System.out.print("수행평가 :"); int 수행평가= scanner.nextInt(); //40%반영
       ...
       //13. 연산 순서 나열 하고 printf() 에 출력되는 x 와 y 값을 예측하시오.
        //        int x = 10;
        //        int y = x-- + 5 + --x;
        ...
        //14. 나이를 입력받아 나이가 10세이상이면 학생 , 20세이상이면 성인 , 40세이상이면 중년 으로 출력하기
        System.out.print("나이: "); short 나이=scanner.nextShort();
        System.out.println(나이>=40?"중년":나이>=20?"성인":나이>=10?"학생":"");

        // 15.국어 , 영어 , 수학 점수를 입력받아 각 변수에 저장하고 총점(소수점 0자리) 출력 , 평균(소수점 2자리 까지) 출력
...
//        17. 문제17 : 아이디[문자열] 와 비밀번호[문자열] 를 입력받아 아이디가 'admin' 이고 비밀번호가 '1234' 와 일치하면 '로그인성공' 아니면 '로그인실패' 출력 하시오
//            String은 비교연산자 사용 불가능[객체]
//            객체 비교 메소드 : 객체.equals()
//            문자열 비교 : "문자열"equals("비교문자열");
        ...
        System.out.println(
                id.equals("admin") && pw.equals("1234") ? "로그인성공" : "로그인실패"
        );
