...
public class 계산기 { //cs
    ...
    /*
        함수 정의 : 클래스 {} 안에서 작성
        함(상자) 수(숫자) 란? 상자안에 들어있는 수 > 상자안에 들어있는 수

        -왜? 미리 만들어진 코드 > 미리 만들어서 반복적으로 사용하기 위해서
        ...
        4.return 값;
            왜?
                1. 함수종료 할때 2. 함수 종료 후 함수를 호출했던 곳으로 반환할 값
    ...
    */
    ...
    int sumMethod2(){
        //new Random().nextInt(); 난수/랜덤 +-21억 생성 객체
        return new Random().nextInt();
    }

    //3. 매개변수가 없고 반환이 없는 함수
    void sumMethod3(){
        System.out.println("sumMethod3()");
    }

    //4. 매개변수가 있고 반환이 없는 함수
